...
.toc-figures{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:14px}
.toc-figures span{font-size:13.5px;text-align:center;padding:6px 4px;border:1px solid var(--line);border-radius:6px;background:#fffdf7}
...
@media(max-width:720px){
  ...
  .toc-figures{grid-template-columns:repeat(4,1fr);gap:6px}
  .toc-figures span{font-size:12px;padding:5px 2px}
  ...
  <section id="screen-intro">
    ...
    <div class="card">
      ...
      <div class="toc-figures">
        <span>曹操</span><span>诸葛亮</span><span>张良</span><span>韩信</span>
        <span>苏轼</span><span>王安石</span><span>王阳明</span><span>曾国藩</span>
        <span>吕雉</span><span>武则天</span><span>长孙皇后</span><span>冯太后</span>
        <span>李清照</span><span>秦良玉</span><span>孝庄文皇后</span><span>冼夫人</span>
      </div>
